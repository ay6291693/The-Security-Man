class Companies{
 ...
 Companies(this.id,this.index,this.title, this.location, this.image, this.description);
...
List<Companies> companies = [
  ...
  Companies(3,2,
     ...
     " this vision about starting a security company 3 decades ago it was much more than this that he"
      " had in mind. When Mr. D. S. Nair started the business he had four security guards, one security"
      " officer & his first client Muller Engineering in the industrial belt of Halol, the journey since then"
  ...
  Companies(8,4,
      ...
      " Every security guard is trained regularly and is updated with latest security procedures. We are the most "
      "prominent force when it comes to handling security concerns in malls & multiplexes. Apart from the regular "
  ...
  Companies(21,13,
      ...
      "Established in the year 2007, Om Security Services in Waghodia Road, Vadodara "
          ...
          "a firm foothold in it’s industry. The belief that customer satisfaction is as important"
          " as their products and services, have helped this establishment garner a vast base of customers, "
  ...
  Companies(66,16,
      ...
      "Established in the year 2012, D D Services in Chhani, Vadodara is a top player in the "
          ...
          "Over the course of its journey, this business has established a firm foothold in it’s industry. "
          "The belief that customer satisfaction is as important as their products and services, have helped "
          "this establishment garner a vast base of customers, which continues to grow by the day. This business "
          "employs individuals that are dedicated towards their respective roles and put in a lot of effort to "
          "achieve the common vision and larger goals of the company. In the near future, this business aims to "
          "expand its line of products and services and cater to a larger client base. In Vadodara, this "
          "establishment occupies a prominent location in Chhani. It is an effortless task in commuting to this "
          "establishment as there are various modes of transport readily available"),
];